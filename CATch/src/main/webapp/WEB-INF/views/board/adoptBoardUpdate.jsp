...
<h3 class = 'h_title' style="color:#006400;font-size: 50px;">입양게시판</h3><br>
...
<div>
	<input type="file" style="  border:0 solid black;width: 704px;height: 28px;margin-left: 15px;" name="file" id="id_photo">
